defmodule CheckboxProblem.CheckboxesTest do
  use CheckboxProblem.DataCase
  ...
  describe "checkboxes" do
    ...
    @valid_attrs %{example_checkbox: true, not_blank: "some not_blank"}
    @update_attrs %{example_checkbox: false, not_blank: "some updated not_blank"}
    @invalid_attrs %{example_checkbox: nil, not_blank: nil}
    ...
    test "create_checkbox/1 with valid data creates a checkbox" do
      ...
      assert checkbox.example_checkbox == true
      assert checkbox.not_blank == "some not_blank"
    end
    ...
    test "update_checkbox/2 with valid data updates the checkbox" do
      checkbox = checkbox_fixture()
      assert {:ok, %Checkbox{} = checkbox} = Checkboxes.update_checkbox(checkbox, @update_attrs)
      assert checkbox.example_checkbox == false
      assert checkbox.not_blank == "some updated not_blank"
    end
